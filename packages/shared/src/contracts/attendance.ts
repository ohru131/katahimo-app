...
/**
 * 出勤簿(勤怠)1日分のrow_data(jsonb)の形。doc/db/guidelines.md §2「勤怠row_dataを意味のあるキー・
 ...
 * スキーマとして1か所に書かれる状態にする(doc/db/guidelines.md §2の狙い)。
 */
 ...
 * 段階1では変更しない、というdoc/db/guidelines.md §2の判断に基づく。
 *

 ...
 * (doc/db/guidelines.md §9。廃止しても行は消さない方針のため、一覧からも隠さず「廃止済み」として見せる)。
 */
...
// ──────────────────────────────────────────────────────────────────────────
// 「この顧客が・この日に・このクーポンを使えるか」の判定(doc/db/guidelines.md §9)
//
 ...
 * クーポン名・コードは、適用記録には複製していない(doc/db/guidelines.md §9。割引条件だけを

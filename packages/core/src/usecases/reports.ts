...
export async function saveAccidentReport(
  ...
  // doc/db/guidelines.md §6: targetDob(自由記述由来の生文字列)はtargetDobRawへそのまま残しつつ、
...
export async function getCustomerHistory(
  ...
  // 日報履歴にも適用済みクーポンを含める(doc/db/guidelines.md §9)。事故報告にはcoupon_redemptionsの

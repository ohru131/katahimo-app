...
export function createDemoContainer(deps: DemoContainerDeps): DemoContainer {
  ...
  return {
    ...
    reportAiConfig: new DrizzleReportAiConfigRepository(deps.db),
    customerReportProfiles: new DrizzleCustomerReportProfileRepository(deps.db),
    reportAiGenerations: new DrizzleReportAiGenerationRepository(deps.db),
    crypto,

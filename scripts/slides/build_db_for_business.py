...
card(s, ML + 8.52, 4.08, 4.06, 2.72, "できている範囲", accent=GREEN, items=[
    {'t': [("画面まで動く: ", {'bold': True}), ("顧客・日報・事故報告・領収書・勤怠・クーポン・AIの文面", {})]},
    {'t': [("入れ物だけ: ", {'bold': True}), ("カルテ・予約・請求・入金・相性・移動手当・日報AIの調整材料", {})]},
...
table(s, ML, BODY_TOP, CW,
      ...
      [
          ...
          ["第15章", "教育への関心度(5段階)を誰がいつ付けるか / 負担の大きさ(5段階)の判定基準",
           "日報の文面を組み替える材料が揃わない"],
          ["第15章", "AIが作った文面の記録(入力メモと出力)の保持期間", "記録が際限なく溜まる"],
      ],
      col_w=[0.9, 6.6, 4.5], size=11, hsize=11, row_h=0.34, header_h=0.32, first_bold=True)
note_(s, ML, 6.08, CW, "",
     "上の13件は、いずれも「業務の決めごと」であって、システムの都合ではありません。"

...
erDiagram
    ...
    customers |o--o{ receipts : "tenant_id, customer_id"
    staff |o--o{ receipts : "tenant_id, cancelled_by_staff_id"
...
erDiagram
    ...
    staff |o--o{ customer_notes : "tenant_id, resolved_by_staff_id"
...
erDiagram
    ...
    staff |o--o{ reservations : "tenant_id, created_by_staff_id"
...
erDiagram
    ...
    customers ||--o| customer_payment_profiles : "tenant_id, customer_id"
    ...
    daily_reports |o--o{ invoice_lines : "tenant_id, daily_report_id"
    receipts |o--o{ invoice_lines : "tenant_id, receipt_id"
    coupon_redemptions |o--o{ invoice_lines : "tenant_id, coupon_redemption_id"
    tenants ||--o{ payments : "tenant_id"
    customers ||--o{ payments : "tenant_id, customer_id"
    invoices |o--o{ payments : "tenant_id, invoice_id"
...
erDiagram
    ...
    staff |o--o{ customer_traits : "tenant_id, recorded_by_staff_id"
    ...
    staff |o--o{ staff_traits : "tenant_id, recorded_by_staff_id"
    ...
    staff |o--o{ staff_customer_compatibilities : "tenant_id, rated_by_staff_id"
    ...
    customers |o--o{ travel_legs : "tenant_id, to_customer_id"
    daily_reports |o--o{ travel_legs : "tenant_id, daily_report_id"
...
- `daily_reports_tenant_customer_occurred_idx` `(tenant_id, customer_id, occurred_at DESC NULLS LAST)`
...
- `accident_reports_tenant_customer_occurred_idx` `(tenant_id, customer_id, occurred_at DESC NULLS LAST)`
...
- `receipts_tenant_staff_timestamp_idx` `(tenant_id, staff_id, receipt_timestamp DESC NULLS LAST)`
- `receipts_tenant_customer_timestamp_idx` `(tenant_id, customer_id, receipt_timestamp DESC NULLS LAST)`
...
- `customer_notes_tenant_customer_created_idx` `(tenant_id, customer_id, created_at DESC NULLS LAST)`
...
- `reservations_tenant_customer_start_idx` `(tenant_id, customer_id, start_at DESC NULLS LAST)`
...
- `invoices_tenant_customer_period_idx` `(tenant_id, customer_id, billing_period_start DESC NULLS LAST)`
...
- `payments_tenant_customer_created_idx` `(tenant_id, customer_id, created_at DESC NULLS LAST)`
...
- `transport_allowance_rules_tenant_mode_from_idx` `(tenant_id, transport_mode, effective_from DESC NULLS LAST)`
